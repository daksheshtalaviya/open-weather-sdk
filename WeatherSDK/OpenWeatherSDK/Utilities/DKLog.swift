...
@objcMembers public class DKLog : NSObject {
    ...
    static private var mode: Mode = .release

    public static func setMode(_ newMode: Mode) {
        mode = newMode
    }
    ...
    static func log(_ items: Any..., separator: String = " ", terminator: String = "\n", fileName: String = #fileID, line: Int = #line, function: String = #function, type: LogType = .normal, logMode: Mode? = nil) {
