...
public enum APIError: Error {
    ...
    /// A model representing a failure response in the API.
    /// - Note: The APIErrorModel is an enumeration used to represent failure responses in the API. It provides a structured way to handle and access the failure response data. The failure case contains a Codable object representing the specific failure response model. [Learn Mode](https://openweathermap.org/faq)
    public enum ErrorModel: Error {
        /// A case that encapsulates the failure response data as a Codable object.
